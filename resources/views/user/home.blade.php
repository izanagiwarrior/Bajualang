...
<div class="container">
    ...
    <div style="width: 100%;">
        ...
        <div class="row">
            ...
            @foreach($sedang_promo as $sp)
            <div class="col-3">
                <a href="{{route('create', $sp->id)}}" style="color: #232323; text-decoration: none;">
                    <div class="card" style="width: 100%; border-radius: 8px;box-shadow: 0px 2px 12px rgba(0, 0, 0, 0.1);">
                        ...
                        <div class="card-body">
                            <h5 style="font-weight: light;">{{$sp->name}}</h5>
                            <!-- discount -->
                            <div class="d-flex">
                                <h5 class="bg-success mr-3" style="color: rgba(0, 0, 0, 0.5); border-radius: 3px;font-size: 15px; padding:5px">{{$sp->discount}}</h5>
